        ...
        function init() {
            ...
            $doc.scroll(function() {
                ...
                if (atTop()) {
                    ...
                    if (settings.show_top) { top_link.removeClass(CLASS_BIG).removeClass(CLASS_SMALL).addClass(CLASS_SMALL); }
                    if (settings.show_bottom) { bottom_link.removeClass(CLASS_BIG).removeClass(CLASS_SMALL).addClass(CLASS_SMALL); }
                }
            });
